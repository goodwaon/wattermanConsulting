            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container px-6 py-16 mx-auto text-center">
                    <div className="max-w-xl mx-auto">
                        ...
                        <p className="mt-6 text-gray-500 dark:text-gray-300">Watermann Consulting & Employee Benefits is built on two core principles</p> 
                        <p className="text-gray-500 dark:text-gray-300"> – Professionalism and Integrity - </p>
