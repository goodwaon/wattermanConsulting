...
<footer className="bg-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 mb-20">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-5 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="#section1" className="hover:underline">Home</a>
                      </li>
                      <li className="mb-4">
                          <a href="#section2" className="hover:underline">About</a>
                      </li>
                      <li>
                          <a href="#section3" className="hover:underline">Features</a>
                      </li>
                  </ul>
              </div>
              <div></div>
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://instagram.com/watermannconsulting" className="hover:underline ">Instagram</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://watermannconsulting.com" className="hover:underline">Watermann Consulting™</a>. All Rights Reserved.
          </span>
