...
function Features() {
    ...
    return (
        <div>
            <section className="bg-grey dark:bg-gray-900" id="section3">
                <div className="container px-6 py-10 mx-auto">
                    <div className="lg:flex lg:items-center">
                        <div className="w-full space-y-12 lg:w-1/2 ">
                            <div>
                                <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Watermann Consulting & Employee Benefits</h1>
                            ...
                            <div className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Benefits Management</h1>
                            ...
                            <div className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">HR Consulting</h1>
                            ...
                            <div className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Wealth Management</h1>
