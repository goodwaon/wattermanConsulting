    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 mb-20">
        <div className="md:flex justify-between">
          <div className="mb-6 md:mb-0">
              <Link href="https://benefitsbw.com/" className="flex items-center">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-10 sm:grid-cols-2">
              <div>
                  ...
                  <ul className="text-gray-600  font-medium">
                      <li className="mb-4">
                          <Link href="#section1" className="hover:underline">Home</Link>
                      </li>
                      <li className="mb-4">
                          <Link href="#section2" className="hover:underline">About</Link>
                      </li>
                      <li>
                          <Link href="#section3" className="hover:underline">Features</Link>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-600 font-medium">
                      <li className="mb-4">
                          <Link href="https://instagram.com/watermannconsulting" className="hover:underline ">Instagram</Link>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center ">© 2023 <Link href="https://watermannconsulting.com" className="hover:underline">Watermann Consulting™</Link>. All Rights Reserved.
          </span>
