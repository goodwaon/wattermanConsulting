...
<footer className="bg-white">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 mb-20">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center ">© 2023 <a href="https://watermannconsulting.com" className="hover:underline">Watermann Consulting™</a>. All Rights Reserved.
          </span>
